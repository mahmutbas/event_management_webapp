...
public class EventRestMvcTest
{
    ...
    public void testFindAllEventsCheckExpectedJsonFromApi() throws Exception
    {
        ...
        this.mvc.perform(get("/api/event/all").accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(content().string("[{\"id\":null,\"createTime\":null,\"deleted\":\"0\",\"eventName\":\"JavaDay\",\"eventDate\":null,\"addressText\":null,\"addressLatitude\":null,\"addressLongitude\":null,\"days\":null,\"trackCount\":null}]"));
    }
}
